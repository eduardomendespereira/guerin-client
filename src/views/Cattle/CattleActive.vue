    ...
    <aside class="cattle is-fullheight">
        ...
        <section class="is-flex is-justify-content-center">
            <div class="insert-back">
                ...
                <div class="form">
                    <p style="font-size: 1.2rem;">Você tem certeza que deseja ativar este gado ?</p>
                </div>
...
export default class cattleDetail extends Vue {
    ...
    private onClickActive(): void {
        this.cattleClient.enable(this.cattle)
            .then(
                success => {
                    this.notification = this.notification.new(true, "notification is-success", "Gado ativado com sucesso!");
                },
                error => {
                    console.log(error)
